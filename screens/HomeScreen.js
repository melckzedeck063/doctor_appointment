         ...
         <View className="flex-row justify-between -mt-1 mx-1" >
          ...
          </View>
          {
            ...
            <FlatList className="borderd-2 border-gray-200 rounded pr-3 pl-1" 
             ...
             renderItem={(itemData) => {
              return (
                <ProductCard name={itemData.item.account.firstName} telephone={itemData.item.account.telephone} bibliography={itemData.item.bibliography} lname={itemData.item.account.lastName} image={itemData.item.photo} station={itemData.item.working_station}  experience={itemData.item.experience} id={itemData.item._id} />
              )
             }}
            />
              </>
