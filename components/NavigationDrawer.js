import { View, Text, TouchableOpacity, ScrollView,  StyleSheet, Switch, Platform,TouchableWithoutFeedback } from 'react-native'
  ...
  return (
    <ScrollView showsVerticalScrollIndicator={false}>
     ...
     <View className="border-b border-slate-300 my-2">
              ...
              >
                 <Text className={`text-white font-medium text-sm ${Platform.select({android : 'text-xs'})}`} >New Service</Text>
                 <Text className="mt-0.5">
                   <AntDesign name='arrowright' size={18} color="white" />
                 </Text>
              </TouchableOpacity>
              ...
              >
                 <Text className={`text-white font-medium text-sm ${Platform.select({android : 'text-xs'})}`} >All Doctors</Text>
                 <Text className="mt-0.5">
                   <AntDesign name='arrowright' size={18} color="white" />
                 </Text>
              </TouchableOpacity>
     ...
     <View className="border-b border-slate-300 my-2">
                <Text className={`text-xl font-bold text-white mb-2`}>Appointments & Chats</Text>

              <TouchableOpacity className="py-1.5 px-3 my-1.5 bg-slatee-500 flex flex-row justify-between active:bg-slate-500  hover:bg-slate-500 rounded-lg"
              //  onPress={()  => navigation.navigate('AllOrders') }
              >
                 <Text className={`text-white font-medium text-sm ${Platform.select({android : 'text-xs'})}`} >Appointments</Text>
                 <Text className="mt-0.5">
                   <AntDesign name='arrowright' size={18} color="white" />
                 </Text>
              </TouchableOpacity>
